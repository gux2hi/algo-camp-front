    ...
    <div className="bg-cover bg-center h-screen" style={{ backgroundImage: "url(/img/3.gif)" }}>
      <div className="flex flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="p-4 flex justify-between w-full items-center">
          ...
          <a href="/login/admin/question_info/question_creat">
        ...
        <div className="px-3 py-4 flex justify-center">
          <table className="w-full text-md bg-white shadow-md rounded mb-4">
            ...
            <tr className="border-b">
                    <th className="text-left p-3 px-5">問題ID</th>
                    <th className="text-left p-3 px-5">問題名</th>
                    <th className="text-left p-3 px-5">対応イベント名</th>
                    <th></th>
                </tr>
                ...
                <td className="p-3 px-5"><h1 className="bg-transparent">event</h1></td>
