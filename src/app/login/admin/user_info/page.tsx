    ...
    <div className="bg-cover bg-center h-screen" style={{ backgroundImage: "url(/img/3.gif)" }}>
      <div className="flex flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="p-4 flex justify-between w-full items-center">
          ...
          <a href="/login/admin/user_info/user_creat">
          ...
          <table className="w-full text-md bg-white shadow-md rounded mb-4">
            <tbody>
              <tr className="border-b">
                <th className="text-left p-3 px-5">名前</th>
                <th className="text-left p-3 px-5">ログインID</th>
                <th className="text-left p-3 px-5">登録日</th>
                <th className="text-left p-3 px-5">種別</th>
                <th></th>
              </tr>
              <tr className="border-b hover:bg-orange-100 bg-gray-100">
                <td className="p-3 px-5"><h1 className="bg-transparent">name</h1></td>
                <td className="p-3 px-5"><h1 className="bg-transparent">id</h1></td>
                <td className="p-3 px-5"><h1 className="bg-transparent">data</h1></td>
                <td className="p-3 px-5"><h1 className="bg-transparent">role</h1></td>
                <td className="p-3 px-5 flex justify-end">
                  <a href="/login/admin/user_info/user_edit">
